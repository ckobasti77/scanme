...
export const venueSr = {
  ...
  reservationSubmit: "Pošalji zahtev",
  reservationSubmitting: "Šaljemo…",
  reservationSuccessDefault:
    "Zahtev je primljen. Lokal će vam potvrditi rezervaciju porukom.",
  reservationErrorGeneric: "Slanje nije uspelo. Pokušajte ponovo.",
  reservationDeadlineNote: "Rezervacije su otvorene do {date}.",
  // reservation zones + request semantics (TASK-43).
  fieldZone: "Zona",
  fieldDesiredAt: "Vreme dolaska",
  reservationZoneFullSuffix: "— popunjeno",
  reservationAllFull: "Sva mesta su popunjena.",
  reservationDisclaimer:
    "Šaljete zahtev — rezervacija važi tek kada je lokal potvrdi.",
  ...
  reservationZoneRequired: "Izaberite zonu.",
  reservationZoneInvalid: "Izabrana zona više ne postoji. Osvežite stranicu.",
  reservationZoneFull: "Ova zona je upravo popunjena. Izaberite drugu.",
